...
const SvgCalculatorOutline = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 24 24' {...props}>
		...
		<path
			fill='currentColor'
			d='M3.27 20.45c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06L19.19 2.72c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06L3.8 20.23a.71.71 0 0 1-.53.22ZM16.06 18.75c-.41 0-.75-.34-.75-.75v-5c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75Z'
		/>
		<path
			fill='currentColor'
