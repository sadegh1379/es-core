...
const SvgLoginActivityOutline = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 24 24' {...props}>
		...
		/>
		<path fill='currentColor' d='M14.88 12.75H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h12.88a.749.749 0 1 1 0 1.5Z' />
		<path
			fill='currentColor'
...
export default SvgLoginActivityOutline;
